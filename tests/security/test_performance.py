...
class TestPerformanceBenchmarks:
    ...
    def test_scalability_performance(self, performance_test_client, mock_security_services):
    ...
    def test_concurrent_performance(self, performance_test_client, mock_security_services):
