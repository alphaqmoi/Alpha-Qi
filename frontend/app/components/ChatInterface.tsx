...
// Fixed import path for useAudioAssistant:
import { useAudioAssistant } from "../app/hooks/useAudioAssistant";
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      content:
        "Welcome to Alpha-Q AI! How can I help you with your development today?",
      sender: "ai",
    },
  ]);
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center">
          <div className="flex-1 relative">
            ...
            />
            <button
              className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1 rounded hover:bg-gray-700"
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    <i
                      className={`${
                        isListening
                          ? "ri-mic-fill text-white"
                          : "ri-mic-line text-gray-400"
                      }`}
                    ></i>
                  </button>
                </TooltipTrigger>
