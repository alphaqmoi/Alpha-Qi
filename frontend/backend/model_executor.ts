...
export async function getOptimalExecutionMode(system: SystemInfo): Promise<string> {
...
export async function executeModel({ input_data, model_name, system }: ExecutionParams): Promise<{ result: string }> {
