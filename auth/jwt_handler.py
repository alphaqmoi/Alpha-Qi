...
class JWTHandler:
    ...
    def init_app(self, app):
        ...
        self.access_token_expires = app.config.get('JWT_ACCESS_TOKEN_EXPIRES', 3600)  # 1 hour
        self.refresh_token_expires = app.config.get('JWT_REFRESH_TOKEN_EXPIRES', 604800)  # 7 days
