...
def upgrade():
    ...
    op.add_column(
        "models", sa.Column("device_map", sa.String(length=50), nullable=True)
    )
    op.add_column("models", sa.Column("max_memory", sa.JSON(), nullable=True))
    op.add_column(
        "models", sa.Column("offload_folder", sa.String(length=255), nullable=True)
    )
    ...
    op.add_column(
        "models", sa.Column("optimization_level", sa.String(length=20), nullable=True)
    )
    op.add_column(
        "models", sa.Column("cache_dir", sa.String(length=255), nullable=True)
    )
