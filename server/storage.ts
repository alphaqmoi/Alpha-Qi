...
export class MemStorage implements IStorage {
  ...
  async getChatMessagesByUserId(
    ...
    return Array.from(this.chatMessages.values())
      .filter((message) => {
        ...
        if (projectId !== undefined && message.projectId !== projectId)
          return false;
        return true;
      })
  ...
  async getDeploymentsByUserId(
    ...
    return Array.from(this.deployments.values())
      .filter((deployment) => {
        ...
        if (projectId !== undefined && deployment.projectId !== projectId)
          return false;
        return true;
      })
  ...
  async updateDeploymentStatus(
    ...
    const updatedDeployment: Deployment = {
      ...
      ...(url && { url }),
      ...(logs && {
        logs: deployment.logs ? `${deployment.logs}\n${logs}` : logs,
      }),
    };
